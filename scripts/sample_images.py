...
def load_model(model_path):
    ...
    model = all_pretrained_models(172, name=model_name)
...
def run_model(args, checkpoint, output_dir, loader=None):
    ...
    with torch.no_grad():
        ...
        for batch in loader:
            imgs, objs, boxes, masks, triples, obj_to_img, triple_to_img, attributes = [x for x in batch]
            ...
            if args.use_gt_textures:
                ...
                for obj_name in objs:
                    ...
                    feat = torch.from_numpy(obj_feature[random_index, :]).type(torch.float32)
